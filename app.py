...
# Простейший словарь продуктов и их калорий на 100 г
PRODUCTS = {
    "яблоко": 52,
    "банан": 89,
    "хлеб": 265,
...
def index():
    ...
    return render_template_string(TEMPLATE, products=PRODUCTS, meals=meals,
                                  total=total_calories, tip=tip)
...
<div class="container mt-5">
    ...
    <form method="post" class="mb-4">
        <div class="row g-2">
            ...
            <div class="col-md-4">
                <input type="number" name="grams" class="form-control" placeholder="Граммов" min="1" required>
            </div>
            <div class="col-md-4">
